USE [GTStage_Matt]
GO
/****** Object:  StoredProcedure [dbo].[HGMX_DLOCAL_SALES]    Script Date: 8/19/2020 6:25:12 PM ******/
SET ANSI_NULLS ON
GO
...
UPDATE HGMX_GT_DLOCAL_FULLOUTERJOIN SET ZDIFF_USD = TRANS_AMOUNT_USD_CALC - PROCESSING_AMOUNT
UPDATE HGMX_GT_DLOCAL_FULLOUTERJOIN SET ZDIFF_ABS = ABS(ZDIFF_USD)
UPDATE HGMX_GT_DLOCAL_FULLOUTERJOIN SET ZOTHER_DIFF = ZDIFF_USD
UPDATE HGMX_GT_DLOCAL_FULLOUTERJOIN SET ZFX_DIFF = 
			(CASE 
			 ...
			 END)
/*
	Need to back into zFX_Diff here because DLOCAL settles in USD,
	so we don't know what the local currency for DLOCAL is.
*/
