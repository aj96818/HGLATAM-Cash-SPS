USE [GTStage_Matt]
GO
/****** Object:  StoredProcedure [dbo].[HGMX_DLOCAL_SALES]    Script Date: 1/20/2021 2:23:54 PM ******/
SET ANSI_NULLS ON
GO
...
FULL OUTER JOIN 
	(SELECT
		...
		, COMPANY_CALC, ISNULL(Payment_type, 'Unknown') Payment_Type, TYPE
		, PROCESSING_CURRENCY
	...
	FROM HGMX_DLOCAL
	GROUP BY
		TRANSACTION_ID, COMPANY_CALC, Payment_type, TYPE, Processing_Currency, PROCESSING_DATE
	) DLOCAL
