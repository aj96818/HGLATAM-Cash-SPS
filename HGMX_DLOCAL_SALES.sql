USE [GTStage_Matt]
GO
/****** Object:  StoredProcedure [dbo].[HGMX_DLOCAL_SALES]    Script Date: 11/8/2020 12:08:10 PM ******/
SET ANSI_NULLS ON
GO
...
SELECT
	COMPANY_CALC
	,CAST(CREATION_DATE AS DATE) AS DL_CREATION_DATE
	,SUM((CASE WHEN TYPE = 'CREDIT' THEN NET_SETTLEMENT_AMOUNT * -1 ELSE NET_SETTLEMENT_AMOUNT END)) AS NET_CB_AMT_CALC
