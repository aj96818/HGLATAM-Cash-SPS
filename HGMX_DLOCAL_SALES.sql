USE [GTStage_Matt]
GO
/****** Object:  StoredProcedure [dbo].[HGMX_DLOCAL_SALES]    Script Date: 11/13/2020 3:54:24 PM ******/
SET ANSI_NULLS ON
GO
...
SELECT
	COMPANY_CALC
	,CAST(PROCESSING_DATE as DATE) AS DL_PROCESSING_DATE
	,SUM((CASE WHEN TYPE = 'CREDIT' THEN NET_SETTLEMENT_AMOUNT * -1 ELSE NET_SETTLEMENT_AMOUNT END)) AS DL_NET_SETTLE_AMT
