USE [GTStage_Matt]
GO
/****** Object:  StoredProcedure [dbo].[HGMX_DLOCAL_SALES]    Script Date: 8/24/2020 11:07:59 AM ******/
SET ANSI_NULLS ON
GO
...
/*
I think local currency amount in the Dlocal merchant report is called, "PROCESSING_AMOUNT."
*/
...
UPDATE HGMX_DLOCAL_FX_ADJ SET DEBIT = (CASE WHEN ZFX_DIFF > 0 THEN 0 ELSE ZFX_DIFF * -1 END)
UPDATE HGMX_DLOCAL_FX_ADJ SET CREDIT = (CASE WHEN ZFX_DIFF < 0 THEN 0 ELSE ZFX_DIFF END)
...
WHERE ISNULL(SettledBy_CALC, '') = 'DLOCAL'
	AND zFX_Diff = 0
	AND ZOTHER_DIFF <> 0
