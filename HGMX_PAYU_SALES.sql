USE [GTStage_Matt]
GO
/****** Object:  StoredProcedure [dbo].[HGMX_PAYU_SALES]    Script Date: 3/4/2021 12:10:17 PM ******/
SET ANSI_NULLS ON
GO
...
UPDATE HGMX_PAYU_Cash_JE SET ACCOUNT = '061-10005-000'
...
UPDATE HGMX_PAYU_JE SET DISTYPE = (CASE WHEN ACCOUNT IN ('061-10030-000') THEN '3' ELSE '9' END)
