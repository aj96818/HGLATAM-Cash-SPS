USE [GTStage_Matt]
GO
/****** Object:  StoredProcedure [dbo].[HGMX_PAYU_SALES]    Script Date: 3/11/2021 2:34:01 PM ******/
SET ANSI_NULLS ON
GO
...
UPDATE HGMX_PAYU_GT_Summ SET REFERENCE = zPAYU_Date + ' SALES PAYU'
...
UPDATE HGMX_PAYU_GT_Tax_Summ SET REFERENCE = @vDate_MMddyyyy + ' SALES PAYU'
UPDATE HGMX_PAYU_GT_Tax_Summ SET ACCOUNT = (CASE
		 WHEN TAX_TYPE_CALC = 'VAT' THEN '042-24910-000'
		 WHEN TAX_TYPE_CALC = 'UST' THEN '042-21120-000'
	 		ELSE '042-24940-000' END)
...
EXEC spUpdateJE @TabletoUpdate = 'HGMX_PAYU_Suspense_JE'
				...
				, @TRANTYPE = 5
				, @TRANDATE = @vDate_MMddyyyy
UPDATE HGMX_PAYU_Suspense_JE SET REFERENCE = @vDate_MMddyyyy + ' SALES PAYU'
...
UPDATE HGMX_PAYU_Cash_JE SET REFERENCE = @vDate_MMddyyyy + ' SALES PAYU'
...
UPDATE HGMX_PAYU_Cash_JE SET DISTREF = 'HGMX A/R (USD) - PAYU SALES'
...
UPDATE HGMX_PAYU_JE SET DISTYPE = (CASE WHEN ACCOUNT IN ('061-11001-000') THEN '3' ELSE '9' END)
