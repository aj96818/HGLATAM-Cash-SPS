USE [GTStage_Matt]
GO
/****** Object:  StoredProcedure [dbo].[HGMX_DLOCAL_CASH]    Script Date: 2/19/2021 12:43:30 PM ******/
SET ANSI_NULLS ON
GO
...
UPDATE HGMX_DLOCAL_CASH_JE SET DISTYPE = (CASE WHEN ACCOUNT = '061-10005-000' THEN '1' ELSE '3' END)
