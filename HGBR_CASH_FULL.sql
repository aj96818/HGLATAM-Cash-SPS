USE [GTStage]
GO
/****** Object:  StoredProcedure [dbo].[HGMX_CASH_FULL]    Script Date: 1/12/2021 1:02:24 PM ******/
SET ANSI_NULLS ON
GO
...
--ALTER TABLE GT_Processed_HGLATAM
...
--select top 100 * from GTStage_Matt.dbo.GT_Processed_HGLATAM
--order by date desc

--select distinct Country from GTStage.dbo.GT_Processed_HGLATAM
...
--SELECT DISTINCT TYPE_CALC FROM GTStage.dbo.GT_Processed_HGLATAM 
--select top 100 * from GTStage.dbo.GT_Processed_HGLATAM order by date desc
