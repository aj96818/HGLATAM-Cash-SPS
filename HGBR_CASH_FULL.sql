...
FROM GT_Processed_HG_Brazil_New A 
...
--select top 100 * from GTStage.dbo.GT_Processed_HG_Brazil_New
--order by date desc

--select distinct Country from GTStage.dbo.GT_Processed_HG_Brazil_New
...
--SELECT DISTINCT TYPE_CALC FROM GTStage.dbo.GT_Processed_HG_Brazil_New 
--select top 100 * from GTStage.dbo.GT_Processed_HG_Brazil_New order by date desc



--ALTER TABLE hgBrazil_temptable
--ADD
