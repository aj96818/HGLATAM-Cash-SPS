USE [GTStage_Matt]
GO
/****** Object:  StoredProcedure [dbo].[HGMX_EXCEPT_TEST_LOOP]    Script Date: 11/13/2020 3:49:22 PM ******/
SET ANSI_NULLS ON
GO
...
--SET @PROC_DATE = '20201001'
--SET @FINISH_DATE = '20201005'
...
SELECT invoice_id, SettledBy_CALC, Currency, COMPANY_CALC_GT, zVIND_GT, TRANS_AMOUNT_USD_CALC, TRANS_AMOUNT_LOCAL_CALC, REVENUE_Amount_USD_CALC, REVENUE_Amount_LOCAL_CALC, GT_DATE, TRANSACTION_ID, COMPANY_CALC, Payment_type, PROCESSING_CURRENCY, PROCESSING_AMOUNT, NET_SETTLEMENT_AMOUNT, GROSS_SETTLEMENT_AMOUNT, PROCESSING_DATE, ZDIFF_USD, ZDIFF_ABS, ZOTHER_DIFF, zFX_Diff, EXCEPTION_NUM, EXCEPTION_ID, ALL_COMPANY FROM HGMX_DLOCAL_EXCEPTION_REPORT
...
--SELECT * FROM HGMX_GT_ALL where business_line_calc = 'unknown'
