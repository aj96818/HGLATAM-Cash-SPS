USE [GTStage_Matt]
GO
/****** Object:  StoredProcedure [dbo].[HGMX_EXCEPT_TEST_LOOP]    Script Date: 10/19/2020 1:47:34 PM ******/
SET ANSI_NULLS ON
GO
...
--	, dlocal.Suspense as [DLOCAL Suspense]
--	, paypal.Suspense as [Paypal Suspense]
--	, payu.Suspense as [PayU Suspense]
--FROM
--	dlocal
--JOIN paypal on dlocal.TRANDATE = paypal.TRANDATE
--JOIN payu on dlocal.TRANDATE = payu.TRANDATE
